...
import assets from "./assets/1.mp4";
function App() {
  const textLines = [
  ...
  return (
      ...
      <div className="sectionThree">
        ...
        >
          ...
          <div className="hamster">
            At the Xiamen University Malaysia, Sepang, Malaysia
          </div>
    ...
    <div class="scrolling-text">Winners Of This Year — Winners Of This Year — Winners Of This Year — Winners Of This Year — Winners Of This Year —</div>
  </div>
      ...
      <div>
        <div className="tilt-right">
          <marquee className="second-marquee" scrollAmount="20">
            {" "}
            Developer Site of the Year — Developer Site of the Year — Developer
            Site of the Year — Developer Site of the Year — Developer Site of
            the Year — Developer Site of the Year —
          </marquee>
          <marquee
            className="third-marquee "
            scrollAmount="20"
            direction="right"
          >
            Igloo Inc — Igloo Inc — Igloo Inc — Igloo Inc — Igloo Inc — Igloo
            Inc — Igloo Inc — Igloo Inc — Igloo Inc — Igloo Inc —
          </marquee>
          <div className="image-container">
            <img
              src="https://assets.awwwards.com/assets/images/pages/awards-2024/trophy.png?v6"
        ...
        <h2 className="heading-two" id="heading-two">
          "Igloo Inc isn’t just an immersive experience <br />
          —  it’s pure art, like your favorite video game <br />
          transformed into a website. Crafted by the mo     <br />
          st talented tech geniuses I’ve ever met, it <br />
          edefines the standards of what kind of <br />
          creative coding should be showcased on the
          <br />
          Awwwards platform. With its unique, delightful
          <br />
          animations, blazing fast performance, and
          <br />
          innovative creative vision, every visit feels like
          <br />
          the first time: evoking that sense of awe <br />
          all over again."
        </h2>
        <div className="side">
          <h3>Share</h3>
      ...
      <div className="sectionFive">
        <video
         ...
         >
          <source src={assets} id="iglo-video" type="video/mp4" />
        </video>

        <img
          className="imgsection-five"
          src="https://assets.awwwards.com/assets/images/pages/awards-2024/media/slider/developer-site-of-the-year/2.jpg"
          alt="secimg"
        />
        <img
          className="imgsection-five"
          src="https://assets.awwwards.com/assets/images/pages/awards-2024/media/slider/developer-site-of-the-year/3.jpg"
          alt="thirdimg"
        />
</div>
<div className="testimonial">
<h2 className="heading-five" >
Introducing Igloo Inc, the parent company <br/>
to Pudgy Penguins and OverpassIP. Our mission <br/>
is to create the largest onchain community,<br/>
driving the consumer crypto revolution.
</h2>
<h2 className="heading-five">Visit Site</h2>
</div>
<div className="btn">
<button className="btn-one">Web & Interactive</button>
 <button className="btn-one">Animation</button>
 <button className="btn-one">Infinite Scroll</button>
</div>
      </div>
